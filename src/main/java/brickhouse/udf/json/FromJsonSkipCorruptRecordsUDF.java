 ...
 * <p/>
 * For example,
 * from_json_skip_corrupt_records( " { "name":"Bob","value":23.0,colors["red","yellow","green"],
 * "inner_map":{"a":1,"b":2,"c":3 }" ,
 * struct("name", "","value", 0.0,"colors", array(""), "inner_map", map("",1) );
 */
@Description(name = "from_json_skip_corrupt_records",
...
public class FromJsonSkipCorruptRecordsUDF extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] arg0) throws HiveException {
        try {
            ...
            /**
             * BSFT use case: Hbase contains some corrupted json records. Throwing exception make whole job fail
             * Skipping corrupted json processing & returning null
             * */
    ...
    public String getDisplayString(String[] arg0) {
        return "from_json_skip_corrupt_records( \"" + arg0[0] + "\" , \"" + arg0[1] + "\" )";
    }
    ...
    public ObjectInspector initialize(ObjectInspector[] arg0)
        ...
        if (arg0.length != 2) {
            throw new UDFArgumentException("from_json_skip_corrupt_records expects a JSON string and a template object");
        }
